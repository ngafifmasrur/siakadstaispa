...
class KelasKuliahController extends Controller
{
    ...
    {
        $query = m_kelas_kuliah::where('id_prodi', Auth::user()->id_prodi);
        ...
        return datatables()->of($query)
            ...
            ->addColumn('action',function ($data) {
                ...
                $button .= view("components.button.default", [
                    ...
                    "route" => route('admin_prodi.kelas_kuliah.update',['kelas_kuliah' => $data->id]),
                ]);
                ...
                $button .= view("components.button.default", [
                    ...
                    "route" => route('admin_prodi.kelas_kuliah.destroy',['kelas_kuliah' => $data->id]),
                ]);
    ...
    public function store(KelasKuliahRequest $request)
    {
        ...
        try{
            ...
            return redirect()->route('admin_prodi.kelas_kuliah.index');
