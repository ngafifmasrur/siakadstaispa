...
class MataKuliahController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin_prodi.mata_kuliah.index', compact('jenis_matkul', 'kelompok_matkul'));
    }
    ...
    public function data_index(Request $request)
    {
        $jenis_matkul = $this->jenis_matkul;
        $kelompok_matkul = $this->kelompok_matkul;
        $query = m_mata_kuliah::query()->where('id_prodi', Auth::user()->id_prodi);
        ...
        return datatables()->of($query)
            ...
            ->addColumn('action',function ($data) {
                ...
                $button .= view("components.button.default", [
                    ...
                    "route" => route('admin_prodi.mata_kuliah.update',['mata_kuliah' => $data->id_matkul]),
                ]);
                ...
                $button .= view("components.button.default", [
                    ...
                    "route" => route('admin_prodi.mata_kuliah.destroy',['mata_kuliah' => $data->id_matkul]),
                ]);
    ...
    public function store(MataKuliahRequest $request)
    {
        ...
        try{
            ...
            return redirect()->route('admin_prodi.mata_kuliah.index');
