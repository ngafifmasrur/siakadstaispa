...
class SemesterMahasiswaController extends Controller
{
        ...
        return datatables()->of($query)
            ...
            ->addColumn('action',function ($data) {
                ...
                $button .= view("components.button.default", [
                    ...
                    "route" => route('admin_prodi.semester_mahasiswa.update', $data->id),
                ]);
                ...
                $button .= view("components.button.default", [
                    ...
                    "route" => route('admin_prodi.semester_mahasiswa.destroy', $data->id),
                ]);
    ...
    public function store(SemesterMHSRequest $request)
    {
        ...
        try{
            ...
            return redirect()->route('admin_prodi.semester_mahasiswa.index');
