...
class UserRepository
{
    ...
    {
        $with = [
            'profile' => new UserProfileRepository($this->model),
            'phone' => new UserPhoneRepository($this->model),
            'email' => new UserEmailRepository($this->model),
            'address' => new UserAddressRepository($this->model),
            'parent' => new UserParentRepository($this->model),
        ];
