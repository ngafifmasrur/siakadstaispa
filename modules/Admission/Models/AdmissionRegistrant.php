...
class AdmissionRegistrant extends Model
{
     ...
     */
    protected $fillable = [
        'kd', 'admission_id', 'kd', 'user_id', 'avatar', 'major1', 'major2', 'agreement', 'payment_id', 'test_at', 'session_id', 'verified_at', 'tested_at', 'validated_at', 'agreement_at', 'paid_off_at', 'accepted_at', 'special', 'is_saman', 'jadwal_wawancara', 'tanggal_kedatangan', 'status_wawancara', 'tanggal_kedatangan'
    ];
