        ...
        <div class="col-md-8">
            <h2 class="mb-0">
                <a class="text-decoration-none small"
                    href="{{ request('next', route('admission.admin.database.manage.periode.index')) }}">
            ...
            <div class="card">
                <div class="card-body">
                    <form
                        action="{{ route('admission.admin.database.manage.periode.update', [
                            'periode' => $periode->id,
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('name') is-invalid @enderror "
                                    name="name" value="{{ old('name', $periode->name) }}" required autofocus>
                                @error('name')
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('year') is-invalid @enderror "
                                    name="year" value="{{ old('year', $periode->period->year) }}" required autofocus
                                    id="datepicker">
                                @error('year')
                                    <span class="invalid-feedback"> {{ $message }} </span>
                                @enderror
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('start_date') is-invalid @enderror "
                                    name="start_date"
                                    value="{{ old('start_date', $periode->start_date ? date('Y-m-d', strtotime($periode->start_date)) : null) }}"
                                    required autofocus>
                                @error('start_date')
                                    <span class="invalid-feedback"> {{ $message }} </span>
                                @enderror
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control @error('end_date') is-invalid @enderror "
                                    name="end_date"
                                    value="{{ old('end_date', $periode->end_date ? date('Y-m-d', strtotime($periode->end_date)) : null) }}" required
                                    autofocus>
                                @error('end_date')
                                    <span class="invalid-feedback"> {{ $message }} </span>
                                @enderror
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="status" id="status">
                                    <option @if (old('status', $periode->open) == 1) selected @endif value="1">Aktif</option>
                                    <option @if (old('status', $periode->open) == 0) selected @endif value="0">Tidak Aktif</option>
                                </select>
                                @error('status')
                                    <span class="invalid-feedback"> {{ $message }} </span>
                                @enderror
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-7 offset-md-4">
                                ...
                                <a class="btn btn-secondary"
                                    href="{{ request('next', route('admission.admin.database.manage.periode.index')) }}">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
