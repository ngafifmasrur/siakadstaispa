...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Nomor HP</li>
@endsection

@section('content')
    <h2 class="mb-0"><a class="text-decoration-none small" href="{{ request('next', url()->previous()) }}"><i class="mdi mdi-arrow-left-circle"></i></a> Ubah nomor HP</h2>
    <hr>
    <div class="row">
        <div class="col-md-8">
            <div class="card">
