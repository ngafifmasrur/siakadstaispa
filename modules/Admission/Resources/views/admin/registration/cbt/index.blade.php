...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Tahap cbt</li>
@endsection

@section('section')
	<div class="section">
	    <h3 class="mb-1">Tahap cbt</h3>
	    <div class="mb-2">Kelola bagian cbt pendaftaran.</div>
	</div>
@endsection
...
@section('content')
    <div class="card">
        ...
        <div class="card-body bg-light border-top">
            <form class="form-block" id="search-form" action="{{ route('admission.admin.registration.cbt.index') }}" method="GET">
                ...
                <div class="form-inline">
                    ...
                    <div class="my-1 mr-sm-2">
                        ...
                        <a class="btn btn-secondary" href="{{ route('admission.admin.registration.cbt.index') }}"><i class="mdi mdi-refresh"></i> Refresh</a>
                    </div>
                </div>
            </form>
        </div>
                        ...
                        @forelse($registrants as $registrant)
                            <tr class="{{ empty($registrant->special) ?: 'table-warning' }}">
                                ...
                                <td class="py-2 align-middle border-left text-center" nowrap>
                                    <a class="btn btn-success btn-sm" href="{{ route('admission.admin.registration.cbt.show', ['registrant' => $registrant->id]) }}"><i class="mdi mdi-format-list-bulleted"></i> Lihat detail </a>
                                </td>
                            </tr>
                        @empty
                            <tr>
