...
@section('subtitle', 'Tambah Tanggal Kedatangan - ')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admission.admin.tanggal_kedatangan.index') }}">Tanggal Ledatangan</a></li>
    <li class="breadcrumb-item active">Tambah tanggal kedatangan</li>
@endsection
...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-body">
                    <form class="form-block" action="{{ route('admission.admin.tanggal_kedatangan.store', ['next' => request('next', url()->previous()) ]) }}" method="POST"> @csrf
                        <fieldset>
