        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card overflow-hidden">
                <div class="card-body pb-0">
                    <div class="d-flex">
                        <div>
                            <p class="mb-1 text-uppercase">Jumlah Program Studi</p>
                        <h2 class="fs-2 mb-3">{{ $total_prodi }}</h2>
                        <a href="{{ route('admin.program_studi.index') }}" class="btn btn-secondary view-more mb-3">List Program Studi</a>
                        </div>
                        <i class="fa fa-book fa-5x ml-auto fs-3 op4 text-danger"></i>
                    </div>
                </div>
            </div>
        </div>
