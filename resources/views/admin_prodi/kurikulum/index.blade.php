...
<x-card-table>
    ...
    <x-slot name="button">
        <a class="btn btn-app btn-sm btn-primary add-form" data-url="{{ route('admin_prodi.kurikulum.store') }}" href="#"><i class="fa fa-plus mr-2"></i>Tambah</a>
    </x-slot>

    <x-datatable 
    :route="route('admin_prodi.kurikulum.data_index')" 
    :table="[
