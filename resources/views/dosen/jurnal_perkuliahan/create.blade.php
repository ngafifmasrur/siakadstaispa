...
<x-card-table>
    ...
    <form action="{{ route('dosen.jurnal_perkuliahan.store') }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                {!! Form::number('pertemuan_ke', null, ['class' => 'form-control '.($errors->has('pertemuan_ke') ? 'is-invalid' : ''), 'id' => 'pertemuan_ke', 'max' => 16, 'min' => 0]) !!}
                @error('pertemuan_ke')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                {!! Form::text('tanggal_pelaksanaan', null, ['class' => 'form-control fc-datepicker-baru '.($errors->has('tanggal_pelaksanaan') ? 'is-invalid' : ''), 'id' => 'tanggal_pelaksanaan', 'placeholder' => 'DD/MM/YYYY', 'autocomplete' => 'off']) !!}
