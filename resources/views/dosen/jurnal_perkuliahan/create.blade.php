...
<x-card-table>
    <x-slot name="title">Form Input Jurnal Kuliah Mata Kuliah: {{ $jadwal->matkul->matkul->nama_mata_kuliah }}</x-slot>
    ...
    <form action="{{ route('dosen.jurnal_perkuliahan.store') }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <x-datatable 
                :route="route('dosen.jurnal_perkuliahan.mahasiswa_data_index', $jadwal->id)" 
                :table="[
