<nav class="horizontalMenu clearfix">
    <ul class="horizontalMenu-list">
        ...
        <li aria-haspopup="true"><a href="#" class="sub-icon {{ set_active(['admin/semester*', 'admin/kurikulum*', 'admin/mata_kuliah*', 'admin/bobot_nilai*', 'admin/kelas_kuliah*','admin/jadwal*', 'admin/ruang_kelas*']) }}"><i class="fa fa-university"></i> Akademik <i class="fa fa-angle-down horizontal-icon"></i></a>
            <ul class="sub-menu">
                ...
                <li aria-haspopup="true"><a href="{{ route('admin.mata_kuliah_aktif.index') }}">Mata Kuliah Aktif</a></li>
