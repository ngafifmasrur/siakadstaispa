<nav class="horizontalMenu clearfix">
    <ul class="horizontalMenu-list">
        ...
        <li aria-haspopup="true"><a href="#" class="sub-icon {{ set_active(['mahasiswa/aktivitas_perkuliahan*', 'mahasiswa/transkrip*', 'mahasiswa/histori_pendidikan*', 'mahasiswa/krs*', 'mahasiswa/histori_nilai*', 'mahasiswa/prestasi_mahasiswa*']) }}"><i class="fa fa-university"></i> Perkuliahan <i class="fa fa-angle-down horizontal-icon"></i></a>
            <ul class="sub-menu">
